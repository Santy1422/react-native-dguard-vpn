...
exports.isDGuardVpnSupported = exports.isAtomVpnSupported = exports.getPlatformRequirements = exports.default = exports.DGuardVPN = exports.AtomVpnSDK = void 0;
var _reactNative = require("react-native");
var _NativeAtomVpn = _interopRequireDefault(require("./NativeAtomVpn"));
...
class AtomVpnSDK {
  isInitialized = false;
  constructor() {
    this.eventEmitter = new _reactNative.NativeEventEmitter(_NativeAtomVpn.default);
  }
  ...
  async initialize(config) {
    try {
      const result = await _NativeAtomVpn.default.initialize(config.secretKey, config.vpnInterfaceName);
  ...
  async connect(properties) {
    ...
    try {
      ...
      await _NativeAtomVpn.default.connect(propertiesJson);
    } catch (error) {
  ...
  async disconnect() {
    try {
      await _NativeAtomVpn.default.disconnect();
    } catch (error) {
  ...
  async cancel() {
    try {
      await _NativeAtomVpn.default.cancel();
    } catch (error) {
  ...
  async getCurrentStatus() {
    try {
      const status = await _NativeAtomVpn.default.getCurrentStatus();
      return status;
    } catch (error) {
  ...
  async isVPNServicePrepared() {
    try {
      return await _NativeAtomVpn.default.isVPNServicePrepared();
    } catch (error) {
  ...
  async getCountries() {
    try {
      const countriesJson = await _NativeAtomVpn.default.getCountries();
  ...
  async getProtocols() {
    try {
      const protocolsJson = await _NativeAtomVpn.default.getProtocols();
  ...
  async getCountriesForSmartDialing() {
    try {
      const countriesJson = await _NativeAtomVpn.default.getCountriesForSmartDialing();
      return JSON.parse(countriesJson);
    } catch (error) {
  ...
  async getRecommendedLocation() {
    try {
      const locationJson = await _NativeAtomVpn.default.getRecommendedLocation();
      if (!locationJson) {
  ...
  async getChannels() {
    try {
      const channelsJson = await _NativeAtomVpn.default.getChannels();
  ...
  async getCities() {
    try {
      const citiesJson = await _NativeAtomVpn.default.getCities();
  ...
  async pause(timer) {
    try {
      await _NativeAtomVpn.default.pause(timer);
    } catch (error) {
  ...
  async resume() {
    try {
      await _NativeAtomVpn.default.resume();
    } catch (error) {
  ...
  async setVPNCredentials(username, password) {
    try {
      await _NativeAtomVpn.default.setVPNCredentials(username, password);
    } catch (error) {
  ...
  async setUUID(uuid) {
    try {
      await _NativeAtomVpn.default.setUUID(uuid);
    } catch (error) {
  ...
  async getConnectedIP() {
    try {
      return await _NativeAtomVpn.default.getConnectedIP();
    } catch (error) {
  ...
  async getAtomShieldData() {
    try {
      const dataJson = await _NativeAtomVpn.default.getAtomShieldData();
...
exports.AtomVpnSDK = AtomVpnSDK;
const DGuardVPN = exports.DGuardVPN = new AtomVpnSDK();

// Export as DGuardVPN and AtomVPN for compatibility
var _default = exports.default = DGuardVPN; // Export types for TypeScript users
 ...
 */
const isDGuardVpnSupported = () => {
  return _reactNative.Platform.OS === 'ios' || _reactNative.Platform.OS === 'android';
};

// Legacy alias for backward compatibility
exports.isDGuardVpnSupported = isDGuardVpnSupported;
const isAtomVpnSupported = exports.isAtomVpnSupported = isDGuardVpnSupported;
...
exports.getPlatformRequirements = getPlatformRequirements;
