 ...
 */
export type VpnState = 'DISCONNECTED' | 'CONNECTING' | 'CONNECTED' | 'DISCONNECTING' | 'PAUSED' | 'PAUSING' | 'RECONNECTING' | 'VALIDATING' | 'AUTHENTICATING' | 'REASSERTING' | 'VERIFYING_HOSTNAME' | 'GETTING_FASTEST_SERVER' | 'OPTIMIZING_CONNECTION' | 'GENERATING_CREDENTIALS';
/**
 * Pause timer options
 */
export type PauseTimer = 'MINUTES_5' | 'MINUTES_10' | 'MINUTES_15' | 'MINUTES_30' | 'MINUTES_60' | 'MANUAL';
/**
...
export type PacketsTransmittedCallback = (inBytes: string, outBytes: string, inSpeed: string, outSpeed: string) => void;
/**
